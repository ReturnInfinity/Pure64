...
VBESearch:
	...
	cmp byte [VBEModeInfoBlock.BitsPerPixel], 16	; Make sure this matches the number of bits for the mode!
	jne VBESearch			; If not equal, try next mode
    cmp word [VBEModeInfoBlock.XResolution], 800 ; Set desired XRes here
	jne VBESearch
    cmp word [VBEModeInfoBlock.YResolution], 600 ; Set desired YRes here
	jne VBESearch
